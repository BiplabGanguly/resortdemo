...
export default function RoomFacility({facilityData}) {
    ...
    return (
        <div className='w-full  mt-5 p-5'>
            <div className='p-5'>
                <h4 className='text-sm text-[#AB916C] '>The Essential In-Room Amenities</h4>
            ...
            <div className='w-full  flex justify-around flex-wrap p-5  gap-5 items-center'>
            {
                facilityData.map((item)=>(
                    <div className='lg:w-[21%] md:w-[40%] w-full  h-50  hover:shadow-2xl  transition duration-150 p-3'>
